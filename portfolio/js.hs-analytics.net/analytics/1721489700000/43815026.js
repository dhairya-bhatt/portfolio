/** 
 * HubSpot Analytics Tracking Code Build Number 1.735
 * Copyright 2024 HubSpot, Inc.  http://www.hubspot.com
 */
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setPortalId', 43815026]);
...
_hsq.push(['addHashedCookieDomain', '67915726']);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/43815026.js', 'hs-script-loader']);
...
(function() {
    ...
    hstc.tracking.Tracker.prototype.trackAudioPlay = function(t) {
        ...
        hstc.utils.isEmpty(t.fileId) || (e.afi = t.fileId);
        hstc.utils.isEmpty(t.duration) || (e.ad = t.duration);
        hstc.utils.isEmpty(t.episodeId) || (e.aei = t.episodeId);
        hstc.utils.isEmpty(t.showId) || (e.asi = t.showId);
